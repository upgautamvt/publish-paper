...
\begin{figure}
    ...
    \jinghao{Just realized: where is the corresponding check on
    \texttt{BMC\_MAX\_PACKET\_LENGTH}
    Update: I saw the new commits in main repo, now this code needs update}
    }
    \label{fig:rust-code}
\end{figure}
...
This conversion is achieved through the utilization of \texttt{take\_while}.
    ...
    the corresponding entry \jinghao{this is not in the code}, thus dividing the code into three distinct
