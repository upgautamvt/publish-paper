...
Such complex conditional judgments are intentionally designed for passing the 
    verifier, but constraints of verifier will significantly undermine the readability 
    of the BMC code, which may lead to ambiguities in some places regarding
...
The complexity of the original code, characterized by four levels of nesting,
    ...
    into a clean chain of higher-order functions with lambda function.
