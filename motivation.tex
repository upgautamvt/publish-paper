...
To implement segment rouding (\jinghao{smells like a typo here, but I'm not sure what it should be}) header support, they needed to include code to jump to IP header parsing code while already inside the IP header parsing code.
...
\jinghao{For this snippet we should show where the two labels are in the source code}
...
\milo{Haven't fully built this out yet.}
