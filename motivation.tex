...
We identified two main techniques for restructuring programs: splitting eBPF programs into smaller programs, and refactoring programs \mvle{to reduce verification} complexity and \mvle{overcome} expressiveness limits.
...
To fix the problem, Cilium implemented the access using inline assembly code. %shown in Figure~\ref{fig:inline-asm}.
