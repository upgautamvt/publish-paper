...
We now show how both of these verifier fixes were needed in implementing BMC~\cite{BMC}, an in-kernel cache for Memcached
    based on eBPF.
...
BMC suffers from verifier complexity \mvle{verifier complexity or program complexity?} in its cache
