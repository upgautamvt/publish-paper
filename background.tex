...
possible executions and interactions with the kernel through {\em
  helper functions} \milo{This makes it seem like the helper function safety is checked much more than it is} and ensure safety.  We characterize these verifier
