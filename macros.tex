...
\lstdefinelanguage{myC}[]{C}{
  ...
  morecomment=[f][\color{magenta}]{\ \ \ \ //},
  morecomment=[f][\color{magenta}]{//},
  keywords = {BPF_PROG_TYPE_SECCOMP, SECCOMP_FILTER_FLAG_EXTENDED, SECCOMP_RET_ERRNO, SECCOMP_RET_ALLOW, EPERM},
  keywords = [2]{long, int, u32, const, void, if, return, switch, return, case, break, u64, u8, unsigned, struct, sizeof},
