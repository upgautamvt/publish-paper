...
Our insight is that by using a safe, high-level language that directly
    implements the required safety of the kernel, \mvle{thereby eliminating the need of a verifier?}, the semantic gap can be
...
Here, we list the important safety properties (\jinghao{may need to move to \S\ref{sec:background}})
\begin{itemize}
    \item Memory safety
    \item Type safety
