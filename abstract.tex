...
However, eBPF is contrained by its static verifier, which provides
  safety as its core value proposition but at the same time makes it hard to
...
In this paper, we make the observation that the needed expressiveness and safety
  can be obtained from a safe language like Rust without the verifier.
